...
/**
 * Beautify a camelCase string, snake_case string, or kebab-case string.
 * e.g. "myString" -> "My String"
 * e.g. "my_string" -> "My String"
 * e.g. "my-string" -> "My String"
 * e.g. "myLongStringWithCamelCase" -> "My Long String With Camel Case"
 */
export function beautifyObjectName(string: string) {
  // Handle empty or numeric-only strings
  if (!string || /^\d+$/.test(string)) return string;
