...
const workspacePostEndpoint =
  workspaceClient.admin.organizations[":organizationId"].workspaces.$post;
const workspacePutEndpoint =
  workspaceClient.admin.organizations[":organizationId"].workspaces[":workspaceId"]
    .$put;
const workspacesGetEndpoint =
  workspaceClient.admin.organizations[":organizationId"].workspaces.$get;
...
export const createWorkspace = async (props: {
  ...
  const response = await workspaceClient.admin.organizations[
    ":organizationId"
  ].workspaces.$post({
