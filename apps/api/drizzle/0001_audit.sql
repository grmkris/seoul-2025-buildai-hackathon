...
--> statement-breakpoint
select audit.enable_tracking ('public.items'::regclass);
--> statement-breakpoint
select audit.enable_tracking ('public.customers'::regclass);
--> statement-breakpoint
select audit.enable_tracking ('public.inventory'::regclass);
--> statement-breakpoint
select audit.enable_tracking ('public.inventory_movement'::regclass);
--> statement-breakpoint
select audit.enable_tracking ('public.time_entries'::regclass);
--> statement-breakpoint
select audit.enable_tracking ('public.discount_codes'::regclass);
--> statement-breakpoint
select audit.enable_tracking ('public.tasks'::regclass);
--> statement-breakpoint
select audit.enable_tracking ('public.documents'::regclass);
--> statement-breakpoint
select audit.enable_tracking ('public.conversations'::regclass);
--> statement-breakpoint
